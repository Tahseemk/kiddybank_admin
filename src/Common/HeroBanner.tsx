  ...
  return (
    <section className="hero--banner">
      <div className="hero--slider">
        ...
        >
          <div className="item">
            <img src={require("../asstes/image/hero-banner-1.jpg")} alt="" loading="lazy" />
          </div>
          <div className="item">
            <img src={require("../asstes/image/hero-banner-2.jpg")} alt="" loading="lazy" />
          </div>
          <div className="item">
            <img src={require("../asstes/image/hero-banner-3.jpg")} alt="" loading="lazy" />
          </div>
        </OwlCarousel>
      </div>
      <div className="hero--content-wrapper">
        <div className="hero--content--data">
          <h1 data-aos="fade-up"
            data-aos-duration="1000" >Kiddy Bank</h1>
          <h3 data-aos="fade-up"
